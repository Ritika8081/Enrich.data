...
**👉 [See a live demo (no install)](./docs/demo.html)** — open `docs/demo.html` in your browser to see what the bulk output looks like, with profile cards and AI-drafted outreach. No API keys needed.
...
Built as part of [OpenClaw](https://github.com/openclaw/openclaw). Plugin lives in `extensions/lead-enrichment/`.
